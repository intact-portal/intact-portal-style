...
public class TaxonMapper extends AbstractOntologyMapper<Taxon, Color> implements OntologyFetcher {
    ...
    public void download() {
        try {
            URL url = new URL("https://github.com/obophenotype/ncbitaxon/releases/latest/download/ncbitaxon.obo"); // We cannot use the slim subset as it lacks 500 of our taxIds
